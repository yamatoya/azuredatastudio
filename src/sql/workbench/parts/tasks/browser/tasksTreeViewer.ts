...
import { Step, Task } from 'sql/workbench/parts/tasks/common/tasksModel';

export type TreeElement = Task | Step;
...
export class StepRenderer implements ITreeRenderer<Step, undefined, IStepTemplateData> {
